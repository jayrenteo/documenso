...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'NurseAider - Share' },
    { description: 'I just signed a document in style with NurseAider!' },
    {
      property: 'og:title',
      content: 'NurseAider - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with NurseAider!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for NurseAider.
  throw redirect('https://nurseaider.com');
};
